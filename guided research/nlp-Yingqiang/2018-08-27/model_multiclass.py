...
if(flag_domain=='Restaurant'):
    ...
    binary_mask = utils.binary_mask_generator(train_data_dir + '/SemEval16_Restaurant_Train.json')
    mask = utils.mask_generator(train_data_dir,flag_domain='Restaurant')

    # split masks
    train_binary_mask, valid_binary_mask = data_split(binary_mask)
    train_mask, valid_mask = data_split(mask)

    test_binary_mask = utils.binary_mask_generator(test_data_dir + '/SemEval16_Restaurant_Test.json')
    test_mask = utils.mask_generator(test_data_dir, flag_domain='Restaurant')
    ...
    if(flag_uni_sent_embedding and flag_domain=='Restaurant'):
        ...
        test_uni_embedding = utils.load_embedding(universal_dir + 'Test/uni_sent_Test_52.txt')
